...
public class Panel extends JPanel implements ActionListener{
    ...
    //indicates whether the game has started yet or not
    ...
    public void draw(Graphics graphic) {
        if (game_flag) {
            // to fill the location of the food unit with and oval
      ...
      public void move(){
        //updating the whole body of the snake apart from its body
        for(int i=bodylength;i>0;i--){
            x_snake[i] = x_snake[i-1];
            y_snake[i] = y_snake[i-1];
        }
        //updating the head of the snake according to direction
        switch(dir){
            case 'U':
